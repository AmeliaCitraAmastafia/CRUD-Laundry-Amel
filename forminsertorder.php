                    ...
                    <h1 align="center" class="h3 mb-2 text-gray-800">Masukkan Data Transaksi</h1><br>
                            ...
                            <div class="card">
                                ...
                                <form method="POST" action="prosesinserttransaksi.php">
                                    ...
                                    <input type="text" class="form-control" id="noNota" name="no_nota" required>
                                    </div>
                                    <div class="mb-3">
                                    <label for="tglTransaksi" class="form-label">Tanggal Transaksi</label>
                                    <input type="datetime-local" class="form-control" id="tglTransaksi" name="tgl_transaksi" required>
                                    </div>
                                    <div class="mb-3">
