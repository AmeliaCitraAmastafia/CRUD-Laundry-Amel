        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 align="center" class="h3 mb-2 text-gray-800">Update Data Pelanggan</h1><br>
                            <div class="container">
                            <div class="card">
                                <div class="card-header bg-primary text-white">
                                <h5 class="mb-0">Form Update Data Pelanggan</h5>
                                </div>
                                <div class="card-body">
                                    <?php
                                    include "koneksi.php";
                                    $kd_pelanggan = $_GET['kd_pelanggan'];
                                    $query = mysqli_query ($koneksi, "select * from pelanggan where kd_pelanggan = '$kd_pelanggan'");
                                    $row = mysqli_fetch_array($query);
                                    ?>
                                <form method="post" action="prosesupdatepelanggan.php">
                                    <div class="mb-3">
                                    <label for="kodePelanggan" class="form-label">Kode Pelanggan</label>
                                    <input type="text" class="form-control" id="kodePelanggan" name="kd_pelanggan"  readonly="readonly" value=<?php echo $row['kd_pelanggan'];?>>
                                    </div>
                                    <div class="mb-3">
                                    <label for="namaPelanggan" class="form-label">Nama Pelanggan</label>
                                    <input type="text" class="form-control" id="namaPelanggan" name="nama_pelanggan" value="<?php echo $row['nama_pelanggan'];?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                    <label for="telepon" class="form-label">Nomor Telp</label>
                                    <input type="tel" class="form-control" id="noTelp" name="no_telp" value="<?php echo $row['no_telp'];?>">
                                    </div>
