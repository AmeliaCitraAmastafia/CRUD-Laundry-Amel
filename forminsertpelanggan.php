...
<head>
    ...
    <title>Laundry - Insert Data Pelanggan</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 align="center" class="h3 mb-2 text-gray-800">Masukkan Data Pelanggan</h1><br>
                            <div class="container">
                            <div class="card">
                                <div class="card-header bg-primary text-white">
                                <h5 class="mb-0">Form Input Data Pelanggan</h5>
                                </div>
                                <div class="card-body">
                                <form method="post" action="prosesinsertpelanggan.php">
                                    <div class="mb-3">
                                    <label for="kodePelanggan" class="form-label">Kode Pelanggan</label>
                                    <input type="text" class="form-control" id="kodePelanggan" name="kd_pelanggan" placeholder="Contoh: P00001">
                                    </div>
                                    <div class="mb-3">
                                    <label for="namaPelanggan" class="form-label">Nama Pelanggan</label>
                                    <input type="text" class="form-control" id="namaPelanggan" name="nama_pelanggan" placeholder="Contoh: Amelia">
                                    </div>
                                    <div class="mb-3">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Contoh: Jalan Kucing No. 1">
                                    </div>
                                    <div class="mb-3">
                                    <label for="telepon" class="form-label">Nomor Telepon</label>
                                    <input type="tel" class="form-control" id="telepon" name="no_telp" placeholder="Contoh: 089765434543">
                                    </div>
