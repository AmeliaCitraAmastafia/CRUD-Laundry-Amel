...
<head>
    ...
    <title>Laundry - Insert Data Transaksi</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 align="center" class="h3 mb-2 text-gray-800">Masukkan Data Transaksi</h1><br>
                            <div class="container">
                            <div class="card">
                                <div class="card-header bg-success text-white">
                                <h5 class="mb-0">Form Transaksi Kasir</h5>
                                </div>
                                <div class="card-body">
                                <?php
                                include "koneksi.php";
                                ...
                                <form method="POST" action="prosesupdatetransaksi.php">
                                    ...
                                    <input type="text" class="form-control" id="noNota" name="no_nota"  readonly="readonly"
                    value="<?php echo $row['no_nota']; ?>">
                                    </div>
                                    <div class="mb-3">
                                    <label for="tglTransaksi" class="form-label">Tanggal Transaksi</label>
                                    <input type="datetime-local" class="form-control" id="tglTransaksi" name="tgl_transaksi" value="<?php echo $row['tgl_transaksi']; ?>">
                                    </div>
                                    <div class="mb-3">
                                    <label for="kdPelanggan" class="form-label">Nama Pelanggan</label>
                                    <select class="form-select" id="kdPelanggan" name="kd_pelanggan" required>
    ...
    <!-- total_bayar ditampilkan karena sebelumnya sudah disimpan -->
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="totalBayar" name="total_bayar" value="<?php echo $row['total_bayar'];?>" readonly="readonly">
        </div>
