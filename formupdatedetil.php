...
<?php
session_start();
echo "No Nota = " . (isset($_SESSION['no_nota']) ? $_SESSION['no_nota'] : 'KOSONG');
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 align="center" class="h3 mb-2 text-gray-800">Update Detail Transaksi</h1><br>
                            <div class="container">
                            <div class="card">
                                <div class="card-header bg-success text-white">
                                <h5 class="mb-0">Form Update Detail Transaksi</h5>
                                </div>
                                <div class="card-body">
                                    <?php
                                include "koneksi.php";
                                $kd_detil = $_GET['kd_detil'];
                                $query = mysqli_query ($koneksi, "select * from detil_transaksi inner join paket on paket.kd_paket = detil_transaksi.kd_paket where kd_detil = '$kd_detil' ");
                                $row = mysqli_fetch_array($query);
                                ?>
                                <form method="post" action="prosesupdatedetil.php">
                                    <div class="mb-3">
                                    <label for="KdDetail" class="form-label">Kode Detail</label>
                                    <input type="text" class="form-control" id="kd_detail" name="kd_detil" readonly = "readonly" value = "<?php echo $row['no_nota']; ?>">
                                    </div>
                                    <div class="mb-3">
                                    <label for="noNota" class="form-label">Nomor Nota</label>
                                    <input type="text" class="form-control" id="noNota" name="no_nota"  readonly = "readonly" value = "<?php echo $row['no_nota']; ?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="berat" name="berat" value="<?php echo $row['berat']; ?>">
                                    </div>
        <!-- Harga disembunyikan
        <div class="mb-3">
