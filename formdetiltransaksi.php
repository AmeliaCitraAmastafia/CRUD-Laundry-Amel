        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 align="center" class="h3 mb-2 text-gray-800">Detail Transaksi</h1><br>
                            <div class="container">
                            <div class="card">
                                <div class="card-header bg-success text-white">
                                <h5 class="mb-0">Form Detail Transaksi</h5>
                                </div>
                                <div class="card-body">
                                <form method="post" action="prosesinsertdetil.php">
                                    <div class="mb-3">
                                    <label for="KdDetail" class="form-label">Kode Detail</label>
                                    <input type="text" class="form-control" id="kd_detail" name="kd_detil" required>
                                    </div>
                                    <div class="mb-3">
                                    <label for="noNota" class="form-label">Nomor Nota</label>
                                    <input type="text" class="form-control" id="noNota" name="no_nota" readonly value="<?php session_start(); echo $_SESSION['no_nota']; ?>">
                                    </div>
                                    <div class="mb-3">
